...
class EventVisualizationScreen extends StatefulWidget {
  final String eventID;

  EventVisualizationScreen(this.eventID);

  @override
  _EventVisualizationScreenState createState() =>
      _EventVisualizationScreenState();
}

class _EventVisualizationScreenState extends State<EventVisualizationScreen> {
  @override
            ...
            sliver: SliverSafeArea(
              ...
              sliver: SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  title: Text("Visualizações do Evento",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 16.0,
                      )),
