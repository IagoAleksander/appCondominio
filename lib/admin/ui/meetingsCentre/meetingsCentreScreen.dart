...
class MeetingsCentreScreen extends StatefulWidget {
  @override
  _MeetingsCentreScreenState createState() => _MeetingsCentreScreenState();
}

class _MeetingsCentreScreenState extends State<MeetingsCentreScreen> {
        ...
        body: Column(
          children: [
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: StandardButton(
                label: "Cadastrar nova reunião",
                backgroundColor: ColorsRes.primaryColorLight,
                onTapFunction: () {
                  Navigator.pushNamed(context, Constants.registerMeetingRoute);
                },
              ),
            ),
            Container(
                        ...
                        builder: (_) {
                          return StreamBuilder(
                            stream: Firestore.instance
                                ...
                                .where("meetingDateInMillis",
                                    isLessThan:
                                        feedController.finalDateApplied)
                                                              ...
                                                              child: Padding(
                                                                padding: const EdgeInsets
                                                                    ...
                                                                    left:
                                                                        12.0),
                                                                child: Text(
                                                                  DateUtils.getFormattedDaysFromDate(
                                                                      meeting
                                                                          .meetingDateInMillis),
                                                                  textAlign:
                                                                      TextAlign
                                                              ...
                                                              child: Padding(
                                                                padding: const EdgeInsets
                                                                    ...
                                                                    left:
                                                                        12.0),
                                                                child: Text(
                                                                  DateUtils.getFormattedTimeFromDate(
                                                                      meeting
                                                                          .meetingDateInMillis),
                                                                  textAlign:
                                                                      TextAlign
